...
<head>
  ...
  <link rel="icon" href="https://edge-server.224.works/pyramid/favicon.ico">
...
<header class="container max-w-screen-lg mx-auto py-1 flex flex-wrap items-center">
  <a href="../">
    <img class="h-12 ml-1 mr-2 p-2 hover:opacity-80" src="https://edge-server.224.works/pyramid/logo.svg" alt="Pyramid logo(トップヘ戻る)">
    </img>
  </a>
</header>
...
<body class="container max-w-screen-lg mx-auto flex flex-col min-h-screen">
  <main class="flex-grow">
    <dev class="flex">
      <aside class="w-full mt-2 text-slate-800" aria-label="Sidebar">
        <a class="ml-1" href="">
          <h1
            class="inline-flex items-center rounded bg-slate-100 py-1 pl-2 pr-2 md:pr-4 lg:pr-10 text-slate-800 hover:opacity-90 text-2xl">
        ...
        <a href="#" class="hover:text-slate-700">
          <h3 class="pl-2 mx-2 mt-3 text-lg border-l-2 border-sky-100 hover:border-sky-400 ml-6">べき乗</h3>
        </a>
        <a href="#" class="hover:text-slate-700">
          <h3 class="pl-2 mx-2 mt-3 text-lg border-l-2 border-sky-100 hover:border-sky-400 ml-6">数列</h3>
      </a>
    </aside>
    <section class=" p-2 leading-relaxed">
